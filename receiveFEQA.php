...
$channel_send->queue_declare('feqa_receive', false, true, false, false);
...
$callback = function($req) {
	...
	$channel_send->basic_publish($msg, '', 'feqa_receive');
...
$channel_rec->basic_consume('feqa_send', '', false, false, false, false, $callback);
